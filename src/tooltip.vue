...
export default {
  name: 'tooltip',
  props: ['parent', 'tooltipText', 'length', 'position', 'disabled', 'type', 'styles'],
  data() {
    return {
  ...
  render(createElement) {
    var attributes = this.notDisabled ? {
      ...
      "data-balloon-length": this.attrLength,
      "data-balloon-pos": this.attrPosition
    } : {};
    return createElement(
      this.domObjType,
      {
        attrs: attributes,
        style: this.styleObj,
        domProps: { innerHTML: this.htmlParent }
      }
    );
  }
};
